...
def test_symmetric_ilp_charger(mock_methane_repository, ref_graph):
    charger = SymmetricILPCharger(mock_methane_repository, 2, 10)
    charger.charge(ref_graph, 0)
...
def test_symmetric_dp_charger(mock_methane_repository, ref_graph):
    charger = SymmetricDPCharger(mock_methane_repository, 2)
    charger.charge(ref_graph, 0)
...
def test_symmetric_cdp_charger(mock_methane_repository, ref_graph):
    charger = SymmetricCDPCharger(mock_methane_repository, 2)
    charger.charge(ref_graph, 0)
